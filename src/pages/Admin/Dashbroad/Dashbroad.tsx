                      ...
                      <div className="grid grid-cols-1 gap-7 lg:grid-cols-[1fr_120px] lg:gap-8">
                        <div className=" rounded-lg ">
                          <Stack spacing={1}>
                            ...
                            <Typography variant="h6">
                              {(dataReal[0] as any)?.revenue_month?.newUsers} KH
                            </Typography>
                          </Stack>
                        </div>
                        <div className=" rounded-lg ">
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-200">
                  <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {(dataReal[0] as any)?.revenue_day?.revenue_film_day?.map(
                        (item: any, index: any) => (
                          <tr key={index}>
              ...
              <div className=" rounded-lg ">
                <div className="overflow-x-auto rounded-lg border border-gray-200">
                  <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {(dataReal[0] as any)?.revenue_month?.book_total_mon?.map(
                        (item: any, index: any) => (
                          <tr>
                            <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                              {index + 1}
              ...
              <div className={`${role === 2 ? "hidden" : "rounded-lg"}`}>
                <div className="overflow-x-auto rounded-lg border border-gray-200">
                  <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {(dataReal[0] as any)?.revenue_month?.revenue_film?.map(
                        (item: any, index: any) => (
                          <tr key={index}>
                            <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                              {index + 1}
              ...
              <div className={`${role === 2 ? "hidden" : "rounded-lg"}`}>
                <div className="overflow-x-auto rounded-lg border border-gray-200">
                  <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {(dataReal[0] as any)?.revenue_month?.user_friendly?.map(
                        (item: any, index: any) => (
                          <tr key={index}>
                            <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                              {index + 1}
