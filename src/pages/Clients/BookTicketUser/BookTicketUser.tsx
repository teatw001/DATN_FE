...
const BookTicketUser = () => {
    ...
    const columns: ColumnsType<DataType> = [
        ...
        },
        {
            ...
            align: "center",
            width: "10%",
            filters: getUniqueValues(film, "name")?.map(item => ({ text: item, value: item })),
    ...
    return (
        <div >
            <Table className="bg-white rounded-lg mx-auto px-10" onChange={handleChange} columns={columns} dataSource={dataBookTicket} scroll={{ x: 2200, y: 600 }} />
        </div>
    )
}
